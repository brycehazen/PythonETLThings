...
# onedrive_link = requests.get('https://orlandodiocese-my.sharepoint.com/:x:/r/personal/mcasas_orlandodiocese_org/Documents/Foundation/DataWarehouse/St.%20Vincent%20de%20Paul%20(1-89)/April%202022/Raw%20Data/St.%20Vincent%20de%20Paul%201-89%204-25-2022.csv?d=wa6d71343ce05451683f26e03b08b5d62&csf=1&web=1&e=79BTj8', headers=headers)
onedrive_link = "https://orlandodiocese-my.sharepoint.com/:x:/r/personal/mcasas_orlandodiocese_org/Documents/Foundation/DataWarehouse/St.%20Vincent%20de%20Paul%20(1-89)/April%202022/Raw%20Data/St.%20Vincent%20de%20Paul%201-89%204-25-2022.csv?d=wa6d71343ce05451683f26e03b08b5d62&csf=1&web=1&e=79BTj8"
onedrive_direct_link = create_onedrive_directdownload(onedrive_link )
data = pd.read_excel(onedrive_direct_link)


# Import raw data
# data = pd.read_csv("C:/Users/bhoward/Desktop/Stoof/input/St. Vincent de Paul 1-89 4-25-2022.csv", encoding='latin-1' )
...
redata.to_csv("C:/Users/bhoward/Desktop/Stoof/output/redata.csv", index = False)
# Output failed rows
failed.to_csv("C:/Users/bhoward/Desktop/Stoof/output/Failed.csv", index = False)
# Output passed rows 
passed.to_csv("C:/Users/bhoward/Desktop/Stoof/output/Passed.csv", index = False)
